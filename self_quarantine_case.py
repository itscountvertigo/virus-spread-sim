...
'''
This is the self-quarantining case. Difference from the control (no_lockdown_case.py)

- People who are infected will stop moving.
- Stopping won't happen until after a number of frames (SELF_QUARANTINE_TIME)
'''
...
def update(frame, population, infected_plot=[], death_plot=[]):
    ...
    # set title
    main_plot.set_title('Self-quarantine case')
